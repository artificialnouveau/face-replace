...
def anonymize_emoji(input_folder, output_folder, person_folder=None):
    emoji = cv2.imread('emoji.png')  # Assume this is the path to the emoji image
    ...
    for filename in os.listdir(input_folder):
        ...
        for (x, y, w, h) in faces:
            ...
            if person_folder and os.listdir(person_folder):
                ...
                if label == 0:
                    img[y:y+h, x:x+w] = cv2.resize(emoji, (w, h))
